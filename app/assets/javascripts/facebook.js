    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
            ...
            $.each(data, function(index, invitation) {
                html =
                    html + "<tr>" + "<td>" + count + "</td>" + "<td><a target='_blank' href='https://www.facebook.com/" + invitation.from_id + "'>" + invitation.shortname + "</a></td>" + "<td>" + invitation.amount + "</td>" + "</tr>";
                count++;
            });
        ...
        if (target == '#profile') {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $.each(data, function(index, invitation) {
                        html =
                            html + "<tr>" + "<td>" + count + "</td>" + "<td><a target='_blank' href='https://www.facebook.com/" + invitation.to_id + "'>" + invitation.to_name + "</a></td>" + "<td>" + "GLX" + zfill1(invitation.id, 8) + "</td>" + "<td>" + invitation.created_at + "</td>" + "</tr>";
                        count++;
                    });
